...
const mobileDistanceDisplay = document.getElementById("dist-display");
const mobileGoalsDisplay = document.getElementById("goals-display");
const mobileCoinsDisplay = document.getElementById("coins-display");
...
function handleGameStats(stats) {
  ...
  if (mobileDistanceDisplay) mobileDistanceDisplay.textContent = `${stats.distance}m`;
  if (mobileGoalsDisplay) mobileGoalsDisplay.textContent = `${stats.goals ?? 0}`;
  if (mobileCoinsDisplay) mobileCoinsDisplay.textContent = `${stats.coins ?? 0}`;
