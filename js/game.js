...
export class Game {
  constructor(canvas, options = {}) {
    ...
    this.player = {
      ...
      tackleTime: 0,
      jukeTime: 0,
      tackleDuration: this.tackleDurationBase,
      jukeDuration: this.jukeDurationBase,
      jukeDirection: 1,
      tackleDirection: 1,
      jukeCooldownTimer: 0
    };
  ...
  update(dt) {
    ...
    if (this.goalFlashTime > 0) this.goalFlashTime -= dt;
    if (this.shotResultFlash > 0) this.shotResultFlash -= dt;
    if (this.player.jukeCooldownTimer > 0)
      this.player.jukeCooldownTimer = Math.max(
        0,
        this.player.jukeCooldownTimer - dt
      );
